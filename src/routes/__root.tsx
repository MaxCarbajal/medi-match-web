...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "MediMatch · Recomendación de proveedores médicos" },
      {
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/633fda28-cd17-49e2-bf82-1bd86a6aeeb4/id-preview-c13e25ed--df9b746f-3862-40f4-bd21-d19b56530db2.lovable.app-1784745484335.png",
      },
      {
        name: "twitter:image",
        content:
